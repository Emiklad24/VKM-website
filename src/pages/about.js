...
import AbHero from "../components/AboutHero/AbHero";
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="max-w-xl pr-16 mx-auto mb-10">
            ...
            <p className="mb-6 text-gray-900 leading-8">
              ...
              consulting company licensed in Nigeria. The company was
              established by a group of friends who saw the need for improved
              expertise in providing cutting-edge support to health and
              development projects in Nigeria. The company boasts of experts who
              have worked across international development organizations for
              over 10 years.
            </p>
