...
const projectList = [
...

    {
        ...
        desc_short: "VKM was identified by UNICEF in 2018 to lead the Nigeria component of a multi-country study on the determinants of teacher absenteeism in sub-Saharan Africa.",
...

    {
        ...
        slug: "Research on Civil Registration and Vital Statistics (CRVS) System",
        desc_short: "VKM has carried out several studies on birth registration in Nigeria collaborating with researchers across the world in the process.",
...

    {
        ...
        desc_short: " VKM has expertise in the development of national level policies and strategic plans. Our chief executive led the development of the Nigeria Health Information System Strategic Plan (2014-2018) and the Sierra Leone Health Information System Strategic Plan (2017- 2021).",
...

    {
        ...
        desc_short: "VKM was contracted by UNICEF in January 2019 to conduct an assessment of the Iron-Folic Acid supply chain system in six states (Jigawa, Katsina, Kebbi, Sokoto, Yobe, Zamfara) in Northern Nigeria.",
...

    {
        ...
        desc_short: "VKM was contracted by UNICEF Nigeria (Management for Results Section) in February 2020 to conduct the U-Report 24X7 assessment in the humanitarian response states of Borno, Adamawa and Yobe.",
...

    {
        ...
        desc_short: " In partnership with Viable Helpers Development Organization (VHDO), VKM has developed a mobile application (Reporta Health) for crowdsourcing data on illegal and unregistered health facilities across Nigeria. The app extends the functionality of the Health Facility Registry in the country.",
    ...
    },
    {
        ...
        desc_short: " VKM has over the last couple of years carried out a nationwide study on the Compliance with Disease Surveillance and Notification by Private Healthcare Providers in the country.",
    ...
    },
    {
        ...
        desc_short: " FHI360 in 2019 engaged VKM to conduct a study on the satisfaction of clients with HIV services across 12 states in Nigeria: Adamawa, Akwa Ibom, Anambra, Bauchi, Bayelsa, Borno, Cross River, Edo, Jigawa, Kano, Lagos and Yobe states. More than 2000 respondents were interviewed across these states as part of implementation of this study. ",
    ...
    },
    {
        ...
        desc_short: " VKM was engaged by the White Ribbon Alliance for Safe Motherhood in Nigeria to conduct the endline evaluation of the Respectful Maternity Care program being implemented at the national level and across Kwara state.   ",
    ...
    },
    {
        ...
        desc_short: " VKM was engaged by the TY Danjuma Foundation (a donor) to conduct an independent external evaluation of the Water, Sanitation and Hygiene (WASH) and Well-Being components of its portfolio.   ",
    ...
    },
    {
        ...
        desc_short: " BRAC USA engaged VKM in February 2022 to carry out an outcome evaluation of the economic strengthening component of Adolescent 360 (A360).   ",
