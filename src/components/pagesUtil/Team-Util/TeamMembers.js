        ...
        >
          <div className="relative overflow-hidden transition duration-700 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            <Image
              ...
              src={teamMates?.[4].personal_photos?.[0]?.url || ""}
              alt={teamMates?.[4].personal_photos?.[0]?.alternativeText || ""}
              height={500}
              width={400}
              layout="responsive"
            />
            <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
              ...
              <div className="flex items-center justify-center space-x-3">
                ...
                <a className="text-white transition-colors duration-300 hover:text-mantis-700">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="h-5"
