    ...
    <section className="py-20 xl:pt-24 bg-white">
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          ...
          <motion.div
            className="w-1/2 md:w-1/3 lg:w-1/5 px-4 mb-8 lg:mb-0 shadow-md flex items-center ml-2 h-40 "
          ...
          <motion.div
            className="w-1/2 md:w-1/3 lg:w-1/5 px-4 mb-8 md:mb-0 shadow-md flex items-center ml-2 h-40"
            whileHover={{ scale: 1.03, position: "relative", zIndex: 2 }}
            whileTap={{ scale: 0.95 }}
          >
            <img
